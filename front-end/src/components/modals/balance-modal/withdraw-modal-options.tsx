...
export interface IWithdrawModalOptionsProps {
  handleWithdrawMethod: (method: IPaymentMethod) => void;
}

export const WithdrawModalOptions = ({ handleWithdrawMethod }: IWithdrawModalOptionsProps) => {
  ...
  return (
    <div className="flex w-full flex-col py-6">
      ...
      <div className="mt-3 grid grid-cols-2 gap-3 border-b border-[#12223B] px-9 pb-6 max-md:px-3.5">
        {paymentMethods.map((paymentMethod, idx) => (
          <div
            ...
            onClick={() => handleWithdrawMethod(paymentMethod)}
          >
      ...
      <div className="mt-6 w-full text-center text-xs font-bold text-[#6E88AF8F]">
        All withdraws will be converted to USD value.
      </div>
    </div>
  );
};
